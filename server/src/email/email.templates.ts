export class EmailTemplates {
  static generateOTPEmail(userName: string, otp: string): string {
    return `
<div style="font-family: Arial, sans-serif; max-width: 500px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px; background-color: #f9f9f9;">
  ...
  static generateVerificationEmail(userName: string): string {
    return `
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px; background-color: #f9f9f9;">
  ...
  static generateRejectionEmail(userName: string, reason: string): string {
    return `
<div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px; background-color: #f9f9f9;">
    <!-- En-tête Solidarity -->
    <div style="text-align: center; margin-bottom: 20px;">
  ...
  static generateAdminNotificationEmail(contact: ContactEmailData): string {
    return `
<!DOCTYPE html>
<html>
<head>
...
<body>
  ...
  static generateUserConfirmationEmail(contact: ContactEmailData): string {
    return `
<!DOCTYPE html>
<html>
<head>
