  ...
  <div className="h-screen w-full flex bg-white">
    ...
    <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-slate-50 via-blue-50 to-teal-50 items-center justify-center p-12 overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-lg">
        ...
        <h1 className="text-5xl font-bold text-slate-800 mb-6 leading-tight">Join the Community</h1>
    ...
    <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 lg:p-16 bg-white overflow-y-auto">
      <div className="w-full max-w-2xl mt-auto ">
        ...
        <div className="lg:hidden text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-slate-800">Join Solidarity</h2>
        </div>

        <div className="text-center lg:text-left mb-6">
          <h2 className="text-3xl font-bold text-slate-900 hidden lg:block">Create Account</h2>
        ...
        <div className="space-y-6 mt-6">
          ...
          <p className="text-xs text-center text-slate-400">
            ...
            <a href="#" className="text-solidarity-blue hover:text-blue-600 underline">Terms of Service</a>
            {" "}and{" "}
            <a href="#" className="text-solidarity-blue hover:text-blue-600 underline">Privacy Policy</a>
          </p>
        </div>
      </div>
    </div>
