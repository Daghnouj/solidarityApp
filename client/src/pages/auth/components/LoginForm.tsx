    ...
    <div>
      <form onSubmit={handleSubmit} className="space-y-6" noValidate>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3.5 bg-slate-50 border-2 border-slate-200 rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-solidarity-blue focus:border-solidarity-blue transition-all duration-200 hover:border-slate-300"
            />
          </div>
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-12 py-3.5 bg-slate-50 border-2 border-slate-200 rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-solidarity-blue focus:border-solidarity-blue transition-all duration-200 hover:border-slate-300"
            />
            <button
              type="button"
        ...
        {error && (
          ...
          >
            <svg className="h-5 w-5 text-red-500 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <button
          type="submit"
          disabled={loading}
          className="w-full bg-gradient-to-r from-solidarity-blue to-teal-500 hover:from-blue-600 hover:to-teal-600 py-4 rounded-xl text-white font-semibold text-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-blue-200/50 hover:shadow-xl hover:shadow-blue-300/50 focus:outline-none focus:ring-2 focus:ring-solidarity-blue focus:ring-offset-2 transform hover:scale-[1.02] active:scale-[0.98]"
