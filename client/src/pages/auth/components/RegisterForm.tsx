  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.meta.requestStatus === 'fulfilled') {
        ...
        // Ideally show a toast, but for now redirect with state or just redirect
        ...
        <div className="flex items-center justify-between mb-3">
          {[1, 2, 3].map((step) => (
            <div key={step} className="flex items-center flex-1">
              <div className={`flex items-center justify-center w-12 h-12 rounded-full border-2 transition-all ${currentStep >= step
              ...
              {step < 3 && (
                <div className={`flex-1 h-1.5 mx-2 rounded-full transition-all ${currentStep > step ? "bg-solidarity-blue" : "bg-slate-200"
                  }`} />
              )}
            </div>
          ))}
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3.5 bg-slate-50 border-2 rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-solidarity-blue focus:border-solidarity-blue transition-all duration-200 hover:border-slate-300 ${validationErrors.name ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-slate-200'
                  }`}
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3.5 bg-slate-50 border-2 rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-solidarity-blue focus:border-solidarity-blue transition-all duration-200 hover:border-slate-300 ${validationErrors.email ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-slate-200'
                  }`}
                onChange={handleChange}
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3.5 pr-12 bg-slate-50 border-2 rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 hover:border-slate-300 ${validationErrors.password ? 'border-red-300 focus:border-red-500 focus:ring-red-500' : 'border-slate-200'
                    }`}
                  onChange={handleChange}
        ...
        {currentStep === 2 && (
          <div className="space-y-6">
            ...
            <div className="flex gap-4 pt-2">
              ...
              <button
                type={form.isProfessional ? "button" : "submit"}
                onClick={form.isProfessional ? nextStep : undefined}
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <label
                  htmlFor="document"
                  className={`flex items-center justify-center w-full px-4 py-10 bg-slate-50 border-2 border-dashed rounded-xl cursor-pointer transition-all ${document
